...
(set! condensationIntegrationLevel (cx-create-integer-entry table2 "Integration level for condensation" 'width 14 'row 1 'col 0 ))
(set! condensationIntegrationBins (cx-create-integer-entry table2 "Integration bins for condensation" 'width 14 'row 2 'col 0 ))
(set! coagulationIntegrationLevel (cx-create-integer-entry table2 "Integration level for coagulation" 'width 14 'row 3 'col 0 ))
