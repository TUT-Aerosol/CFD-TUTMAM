...
#define _TUTMAM_SETTINGS_H
	...
	#define initialNumberConc 1.0e10
	/* Count median diameter (m) */
	#define initialCMD 20.0e-9
	/* GSD */
	#define initialGSD 1.3
	...
	#define minCMDForKappaCalculation 1.0e-9
	#define convergenceCriteriumForKappaCalculation 0.1
	...
	/* No condensation (0), condensation only if saturation exceeded (1), full condensation(2) */
	#define wallCondensationLaws 1,1
